...
public static class IdentityServerConstants
{
    ...
    {
        public static readonly string Basic = IdentityServer8.Tracing.TraceNames.Basic;
        public static readonly string Stores = IdentityServer8.Tracing.TraceNames.Store;
        public static readonly string Cache = IdentityServer8.Tracing.TraceNames.Cache;
        public static readonly string Validation = IdentityServer8.Tracing.TraceNames.Validation;
        public static readonly string Services = IdentityServer8.Tracing.TraceNames.Services;

        public static readonly string ServiceVersion = IdentityServer8.Tracing.ServiceVersion;
    }
