...
using IdentityServer8.Services.KeyManagement;
using Microsoft.Extensions.Logging;
using IdentityServer8.Hosting.DynamicProviders;
using IdentityServer8.Internal;
using IdentityServer8.Stores.Empty;
...
public static class IdentityServerBuilderExtensionsCore
{
        ...
        where TEndpoint : class, IEndpointHandler
    {
        ...
        builder.Services.AddSingleton(new IdentityServer8.Hosting.Endpoint(name, path, typeof(TEndpoint)));
