...
public class PersistedGrantStore : IdentityServer8.Stores.IPersistedGrantStore
{
    /// <summary>
    /// The DbContext.
    /// </summary>
    ...
    /// <inheritdoc/>
    public virtual async Task StoreAsync(IdentityServer8.Models.PersistedGrant token)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<IdentityServer8.Models.PersistedGrant> GetAsync(string key)
    {
    ...
    /// <inheritdoc/>
    public virtual async Task<IEnumerable<IdentityServer8.Models.PersistedGrant>> GetAllAsync(PersistedGrantFilter filter)
    {
