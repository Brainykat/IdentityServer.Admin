...
public static class Telemetry
{
    ...
    /// <summary>
    /// Service name used for  IdentityServer.
    /// </summary>
    public const string ServiceName = "IdentityServer8";

    /// <summary>
    /// Service name used for the experimental non stable counters from  IdentityServer
    /// </summary>
    public const string ServiceNameExperimental = "IdentityServer8.Experimental";
