...
namespace IdentityServer.Admin.UI.Helpers.ApplicationBuilder
{
    ...
    {
        /// <summary>
        /// Adds the IdentityServer Admin UI to the pipeline of this application. This method must be called 
        ...
        /// <summary>
        /// Maps the IdentityServer Admin UI to the routes of this application.
        /// </summary>
        ...
        /// <summary>
        /// Maps the IdentityServer Admin UI health checks to the routes of this application.
        /// </summary>
        /// <param name="endpoint"></param>
