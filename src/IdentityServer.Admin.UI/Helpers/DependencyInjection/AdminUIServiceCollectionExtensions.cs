...
namespace IdentityServer.Admin.UI.Helpers.DependencyInjection
{
    ...
    {
        /// <summary>
        /// Adds the IdentityServer Admin UI with the default entity model.
        /// </summary>
        ...
        /// <summary>
        /// Adds the IdentityServer Admin UI with a custom user model and database context.
        /// </summary>
        ...
        /// <summary>
        /// Adds the IdentityServer Admin UI with a fully custom entity model and database contexts.
        /// </summary>
        /// <param name="services"></param>
        /// <param name="optionsAction"></param>
        /// <returns></returns>
